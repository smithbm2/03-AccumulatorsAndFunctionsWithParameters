...
#       rectangle = rg.Rectangle(rg.Point(1, 2), rg.Point(3, 4))
#
...
#             objects have:
#                radius, center point, and color
#
#     f. What does a RoseWindow RENDER method do?
#            This displays objects on the window without showing them being drawn. It allows a time frame or action to be specified for how long the window remains open
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            It is necessary when no time value is specified for the window to remain open. It is necesssary because without it, it only stays open for a brief second.
#
