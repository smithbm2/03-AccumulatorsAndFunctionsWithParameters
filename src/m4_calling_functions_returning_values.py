...
def run_test_sum_of_digits():
    ...
    #  Test 2:
    expected = 13
    answer = sum_of_digits(1093)
    print('Test 2 expected:', expected)
    print('       actual:   ', answer)

    #  Test 3:
    expected = 17
    answer = sum_of_digits(782)
    print('Test 3 expected:', expected)
    print('       actual:   ', answer)

    #  Test 4:
    expected = 7
    answer = sum_of_digits(1111111)
...
def run_test_digits_in_cube():
    ...
    # -------------------------------------------------------------------------
    # DOEN: 3. Implement this function.
...
def run_test_digits_in_power():
    ...
    #  Test 2:
    expected = 9
    answer = digits_in_power(21,2)
    print('Test 2 expected:', expected)
    print('       actual:   ', answer)

    #  Test 3:
    expected = 27
    answer = digits_in_power(72,3)
    print('Test 3 expected:', expected)
    print('       actual:   ', answer)
...
def fancy_sums_of_digits(n):
    ...
    firstnumber = n**1000
    secondnumber = n**999
    X = sum_of_digits(firstnumber)
    Y = sum_of_digits(secondnumber)
    answer = X**Y
